...
class CaptionModel_txtcon(nn.Module):
    def __init__(self, opt):
        super(CaptionModel_txtcon, self).__init__()
        self.current_device = opt.device_num
...
#                     it = beam_seq_table[divm][t-divm]
                    ...
                    it = torch.t(it) #AK
                    logprobs_table[divm], state_table[divm] = self.get_logprobs_state(it.cuda(self.current_device), *(args[divm] + [state_table[divm]]))
