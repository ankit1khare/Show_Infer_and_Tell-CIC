...
class DataLoader(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.vocab_size = len(self.ix_to_word) #it's from cocotalk not model infos
#         f = open("ix_to_word.txt", "w")
#         f.write(str(self.ix_to_word))
        ...
        for ix in range(len(self.info['images'])):
            ...
            if img['split'] == 'train':
                ...
                self.split_ix['train'].append(ix) #self.split_ix['test'].append(ix)
            elif opt.train_only == 0: # restval
                self.split_ix['train'].append(ix) #coco tests mods
